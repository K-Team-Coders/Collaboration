...
Скрипты алгоритма будут установлены в вашей локальной системе. Получить копию можно следующим способом:
* спользуйте git clone для создания каталога с именем algo, содержащего сценарии алгоритма:
