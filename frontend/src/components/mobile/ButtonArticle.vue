  ...
  <div>
    ...
    <div v-show="button_frontend == false">
      ...
      <div class="checkbox_main">
        <ul>
          <li>
            <input class="inputcheck" id="checkbox6" type="checkbox" style="display: none;" value="Товар поврежден"
              v-model="checked" />
          ...
          <li>
            <input class="inputcheck" id="checkbox7" type="checkbox" style="display: none;"
              value="Товара не соответствует описанию" v-model="checked" />
            <label class="checkbox" for="checkbox7">
              ...
              <span>Товара не соответствует описанию</span>
            </label>
          </li>
        </ul>
      </div>
